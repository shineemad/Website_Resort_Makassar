...
const PLACES = [
  {
    ...
    dist: "0 m",
    narrative: "Sunset line paling ikonik di kota ini — cukup melangkah keluar lobi dan Anda langsung tiba di tepi laut.",
  },
  {
    id: "02",
    ...
    dist: "400 m",
    narrative: "Siluet arsitektur terapung yang tenang di atas air, cocok untuk momen pagi dan sore hari.",
  },
  {
    id: "03",
    name: "Somba Opu",
    detail: "5 menit jalan kaki",
    dist: "500 m",
    narrative: "Koridor belanja khas Makassar untuk membawa pulang rasa dan cerita lokal.",
  },
  {
    id: "04",
    ...
    dist: "700 m",
    narrative: "Ruang sejarah yang memperlihatkan lapisan budaya kota pelabuhan dari abad ke abad.",
  },
  {
    id: "05",
    name: "Trans Studio",
    ...
    dist: "8 km",
    narrative: "Destinasi hiburan modern untuk keluarga, ideal saat ingin agenda yang lebih dinamis.",
  },
];
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        eyebrowRef.current,
        { opacity: 0, x: -20 },
        { opacity: 1, x: 0, duration: 0.8, ease: "expo.out", scrollTrigger: entSt },
      );
      ...
      if (headlineRef.current) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 48 },
          { opacity: 1, y: 0, duration: 1.0, ease: "expo.out", stagger: 0.09, delay: 0.06, scrollTrigger: entSt },
        );
      }
      ...
      gsap.fromTo(
        coordRef.current,
        { opacity: 0, y: 12 },
        { opacity: 1, y: 0, duration: 0.65, ease: "power3.out", delay: 0.32, scrollTrigger: entSt },
      );

      gsap.fromTo(
        mapRef.current,
        { opacity: 0, y: 32, scale: 0.97 },
        { opacity: 1, y: 0, scale: 1, duration: 1.2, ease: "expo.out", delay: 0.1, scrollTrigger: entSt },
      );

      gsap.fromTo(
        itemRefs.current.filter(Boolean),
        { opacity: 0, x: -16 },
        { opacity: 1, x: 0, duration: 0.6, ease: "power3.out", stagger: 0.06, delay: 0.24, scrollTrigger: { trigger: sectionRef.current, start: "top 75%" } },
      );
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          fontSize: "clamp(48px,6.5vw,96px)", letterSpacing: "0.12em",
          color: "rgba(36,18,8,0.028)", pointerEvents: "none",
          zIndex: 0, whiteSpace: "nowrap", userSelect: "none",
        }}
      >
        −5.1477° S &nbsp; 119.4327° E
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          <span
            style={{
              ...
              letterSpacing: "-0.04em", color: T.primary, opacity: 0.38,
            }}
          >05</span>
          <div style={{ width: "0.8px", height: "20px", background: "rgba(36,18,8,0.12)" }} />
          <span
            style={{
      ...
      <div
        ...
        style={{
          ...
          display: "grid", gridTemplateColumns: "46fr 54fr",
      ...
      >
        ...
        <div
          style={{
            ...
            padding: "clamp(44px,5.5vh,72px) clamp(28px,5.5vw,72px) clamp(40px,5vh,60px)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              marginBottom: "clamp(18px,2.4vh,28px)", opacity: 0,
            }}
          >
          ...
          >
            <span className="loc-hl" style={{
              fontFamily: T.display, fontWeight: 200,
              fontSize: "clamp(42px,4.8vw,74px)", lineHeight: 0.93,
              letterSpacing: "-0.032em", color: T.dark,
            }}>Jantung</span>
            <span className="loc-hl" style={{
              fontFamily: T.display, fontWeight: 200,
              fontSize: "clamp(42px,4.8vw,74px)", lineHeight: 0.93,
          ...
          <div
            ...
            style={{
              ...
              marginBottom: "clamp(28px,3.8vh,48px)", opacity: 0,
            }}
          >
            <Navigation2 size={11} strokeWidth={1.5} style={{ color: T.primary, flexShrink: 0 }} />
            <span
              style={{
                fontFamily: T.body, fontSize: "9.5px",
                letterSpacing: "1.8px", textTransform: "uppercase",
                color: "rgba(36,18,8,0.38)",
              }}
            >−5.1477° S, 119.4327° E</span>
            <div style={{ flex: 1, height: "0.8px", background: "rgba(36,18,8,0.08)" }} />
          </div>
          ...
          <div style={{ display: "flex", gap: "16px", flex: 1 }}>
            ...
            <div
              style={{
                position: "relative", width: "1.5px", flexShrink: 0,
            ...
            >
              <div
                ...
                style={{
                  ...
                  transformOrigin: "top center", transform: "scaleY(0.02)",
                  borderRadius: "1px",
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "baseline", gap: "12px" }}>
                      <span
                        ...
                        style={{
                          fontFamily: T.body, fontSize: "9px", letterSpacing: "1.8px",
                          color: isCur ? T.primary : "rgba(36,18,8,0.24)", flexShrink: 0,
                        }}
                      >{place.id}</span>
                      <span
                        ...
                        style={{
                          fontFamily: T.display, fontWeight: 200,
                          fontSize: "clamp(14px,1.5vw,19px)", letterSpacing: "-0.02em",
                          color: isCur ? T.dark : "rgba(36,18,8,0.45)", flex: 1,
                        }}
                      >{place.name}</span>
                      <span
                        className="loc-item-dist"
                        style={{
                          fontFamily: T.body, fontSize: "9px", letterSpacing: "1.4px",
                          textTransform: "uppercase",
                          color: isCur ? T.primary : "rgba(36,18,8,0.2)", flexShrink: 0,
                        }}
                      >{place.dist}</span>
                    </div>
                    ...
                    >
                      <p
                        style={{
                          fontFamily: T.body, fontSize: "11.5px",
                          lineHeight: 1.66, color: "rgba(36,18,8,0.52)",
                          paddingLeft: "26px", margin: 0,
                        }}
                      >{place.narrative}</p>
                    </div>
                  </div>
        ...
        >
          <div className="loc-sticky" style={{ position: "sticky", top: "clamp(18px,2.5vh,36px)" }}>
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "7px" }}>
                  <MapPin size={11} strokeWidth={1.6} style={{ color: T.primary }} />
                  <span
                    style={{
                      fontFamily: T.body, fontSize: "9px",
                      letterSpacing: "1.8px", textTransform: "uppercase",
                ...
                <span
                  style={{
                    fontFamily: T.body, fontSize: "9px",
                    letterSpacing: "1.6px", textTransform: "uppercase", color: T.primary,
                  }}
                >{active.detail}</span>
              </div>

              {/* Iframe */}
              <div style={{ height: "clamp(290px,42vh,540px)", position: "relative" }}>
                <iframe
              ...
              >
                <span
                  style={{
                    fontFamily: T.display, fontWeight: 200,
                    fontSize: "16px", letterSpacing: "-0.02em", color: T.dark,
                  }}
                >{active.name}</span>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  <div
                    style={{
                      ...
                      background: T.primary, boxShadow: "0 0 5px rgba(244,124,89,0.45)",
                    }}
                  />
                  <span
                    style={{
            ...
            <div
              style={{
                marginTop: "18px", paddingLeft: "4px",
            ...
            >
              <div
                style={{
                  ...
                  background: T.primary, opacity: 0.45, flexShrink: 0,
                }}
              />
              <div>
                <p
                  style={{
                    ...
                    color: "rgba(36,18,8,0.3)", marginBottom: "5px",
                  }}
                >Alamat</p>
                <p
                  style={{
                    fontFamily: T.display, fontWeight: 200,
                    fontSize: "14.5px", lineHeight: 1.52, letterSpacing: "-0.012em",
                    color: "rgba(36,18,8,0.58)",
                  }}
                >
                  Jl. Pasar Ikan No. 52,<br />
